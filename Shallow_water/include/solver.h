...
protected:
    SphericalSolver(SphericalProblem& problem, unsigned int n_1, unsigned int n_2, unsigned int k);
};
...
public:
    ...
    SphericalSolver getSolver(SphericalProblem& problem, unsigned int n_1, unsigned int n_2, unsigned int k);
};
